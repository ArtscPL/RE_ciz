...
+ [รับภารกิจ]
    ...
    ขอบคุณมาก แน่นอนว่าเราไม่ได้จะให้ทำงานฟรีๆหรอกนะ ถ้าเธอจัดการหมาป่าครบ 15 ตัวแล้วก็มารับเงินรางวัลได้เลย ฝากด้วยหละนักผจญภัยหนุ่ม #speaker:หัวหน้ายาม #portrait:GuardLeader
    ~isS104 = true
    ~questAccepted = true
    ->DONE
+ [ปฏิเสธ]
